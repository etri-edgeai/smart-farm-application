...
import { FSDocument, FSDocumentElement } from '@front/components/fullscreen/fullscreen.types';
...
@Component({
  ...
  exportAs: 'frontFullscreen',
})
export class FrontFullscreenComponent implements OnInit {
